...
from f5_tts_hindi.model import CFM
from f5_tts_hindi.model.dataset import DynamicBatchSampler, collate_fn
from f5_tts_hindi.model.utils import default, exists
...
class Trainer:
    ...
    def train(self, train_dataset: Dataset, num_workers=16, resumable_with_seed: int = None):
        if self.log_samples:
            from f5_tts_hindi.infer.utils_infer import cfg_strength, load_vocoder, nfe_step, sway_sampling_coef
